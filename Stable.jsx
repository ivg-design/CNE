(function(thisObj) {
    ...
    function buildUI(thisObj) {
        ...
        { // Script's UI Code
            // PANEL1
            // ======
            var panel1 = myPanel.add("panel", undefined, undefined, { name: "panel1" });
            ...
            var null_settings_dd = group1.add("dropdownlist", undefined, undefined, { name: "null_settings_dd", items: null_settings_dd_array });
            ...
            var position_settings_dd = group2.add("dropdownlist", undefined, undefined, { name: "position_settings_dd", items: position_settings_dd_array });
            ...
            var control_structure_dd = group3.add("dropdownlist", undefined, undefined, { name: "control_structure_dd", items: control_structure_dd_array });
            ...
            var create_null_btn = group4.add("button", undefined, undefined, { name: "create_null_btn" });
            ...
            var iconbutton1 = group5.add("iconbutton", undefined, File.decode(iconbutton1_imgString), { name: "iconbutton1", style: "toolbutton" });
        ...
        UpdateArrayOnChange(null_settings_dd, updateDD);
        // reload button
        ...
        function updateDD(arr) {
            position_settings_dd.removeAll();
            for (var i = 0; i < arr.length; i++) {
                position_settings_dd.add("item", arr[i]);
            }
        }
    }

    // Write your helper functions here
    function UpdateArrayOnChange(null_settings_dd, updateDD) {
